...
import { workExperience } from "@/public/Data/data";
export default function WorkExpirience() {
  return (
    <>
      <Header headerName={"Work Experience"}></Header>
      <div className={styles.content}>

        {workExperience.map((item, index) => (<div key={index} style={{ paddingBottom: '20px' }}><Grid container spacing={2} flexDirection={'column'} paddingBottom={'10px'}>
